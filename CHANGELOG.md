...
- **플러그인 알림 카드가 자기 판을 벗어나지 않습니다.** 판이 워크보드·설정·플러그인
  화면을 보여주는 동안 도착한 플러그인 알림 카드(예: 메일 작업 제안)가 판 바깥의 창
  하단 띠에 나타났습니다. 이제 카드는 판이 무엇을 보여주든 그 판의 오른쪽 위에 떠
  있고, 대화 화면으로 돌아가도 같은 자리에 남습니다. 창 하단 띠는 원래 대화가
  화면에서 사라진 카드, 판이 닫힌 카드, 열린 판이 없을 때 도착한 카드만 받습니다.
