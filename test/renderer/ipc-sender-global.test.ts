...
const CHANNEL_MANIFEST: Record<string, "mutating" | "sensitive" | "public-read"> = {
  ...
  "lvis:memory:candidates:list": "sensitive",
  "lvis:memory:candidates:activate": "mutating",
  "lvis:memory:candidates:delete": "mutating",
  "lvis:memory:entries:search": "sensitive",
  "lvis:memory:index:get": "sensitive",
  "lvis:memory:long-term:refresh": "sensitive",
