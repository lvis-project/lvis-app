 ...
 * (C:\Users\example\workspace\lvis-project\lvisai.xyz\lib\screenshots.ts).
 *
...
/**
 * mp-* / ah-* / ep-* keys (marketplace, agent-hub SERVER dashboards, ep-api
...
export const WEB_SERVER_KEYS_OUT_OF_SCOPE = [
  ...
  'ep-internal-search', 'ep-internal-search-2',
] as const;
