...
export function createDesktopNetworkFetch(): Pick<BootHost, "networkFetch" | "singleHopNetworkFetch" | "llmFetch"> {
  ...
  return { networkFetch, singleHopNetworkFetch: createSingleHopFetch(), llmFetch };
}
