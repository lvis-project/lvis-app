 ...
 * (`Boolean(result?.authenticated)`, `String(result?.account ?? "")`); the
 * shape is documented but not AJV-validated in v1 — outputSchema validation
 * is a separate cross-cutting change. Plugins MAY return additional fields;
