  ...
  it("locks the sorted unique channel list", () => {
    ...
    expect(sorted).toMatchInlineSnapshot(`
      [
        ...
        "lvis:home-docs:custom:get",
        "lvis:home-docs:custom:update",
        "lvis:home-docs:marker:keep-mine",
        "lvis:home-docs:marker:read",
        "lvis:home-docs:merge:apply",
        "lvis:home-docs:merge:discard",
        "lvis:home-docs:merge:run",
        "lvis:home-docs:packaged:apply",
        "lvis:home-docs:upgrade-markers:list",
        "lvis:host:plugin-theme-notify",
        "lvis:llm:ping",
        "lvis:logs:tail",
        "lvis:marketplace:ping",
        "lvis:mcp:attach-resource",
        "lvis:mcp:attach-resource-template",
        "lvis:mcp:call-tool",
        ...
        "lvis:mcp:kill",
        "lvis:mcp:list-resource-templates",
        "lvis:mcp:list-resources",
        "lvis:mcp:servers",
        ...
        "lvis:plugins:e2e:bundle-snapshot",
        ...
        "lvis:runtime:counts",
        "lvis:runtime:env",
        "lvis:session-goal:clear",
        "lvis:session-goal:get",
        "lvis:session-goal:pause",
        "lvis:session-goal:resume",
        "lvis:session-tasks:clear",
        "lvis:session-tasks:list",
        ...
        "lvis:tailnet-observer:configure-serve",
        "lvis:tailnet-observer:guided-setup",
        "lvis:tailnet-observer:set-own-device-admission",
        ...
        "lvis:work-board:accept-proposal",
        "lvis:work-board:add",
        "lvis:work-board:complete",
        "lvis:work-board:dismiss-proposal",
        "lvis:work-board:generate-report",
        "lvis:work-board:get",
        "lvis:work-board:list",
        "lvis:work-board:list-proposals",
