...
function FloatingPanel({ children }: { children: ReactNode }) {
  ...
  return (
    <aside
      ...
      className="lvis-surface-floating absolute right-3 top-3 z-50 flex w-[23rem] max-w-[calc(100vw-2rem)] flex-col overflow-hidden rounded-xl bg-card/(--opacity-solid) text-card-foreground backdrop-blur"
