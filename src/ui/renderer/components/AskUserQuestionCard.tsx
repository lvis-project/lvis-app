...
export interface AskUserQuestionItem {
  ...
  /**
   * 3 contextual answer suggestions generated by the model for this turn.
   * Rendered as quick-chip buttons above the free-text input by FloatingQuestionPanel.
   * Required when allowFreeText=true and choices is empty/absent.
   */
