 ...
 * violet bundles report "lg" so existing plugins that branch on chatTheme
 * continue to identify the violet context correctly. All other bundles
...
function legacyChatTheme(bundle: ThemeBundle): "default" | "lg" | "purple" | "orange" | "blue" {
  if (bundle.id === "violet-light" || bundle.id === "violet-dark") return "lg";
  return "default";
}
