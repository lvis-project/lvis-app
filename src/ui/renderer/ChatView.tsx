...
function AskUserAnswerBubble({
  ...
  if (entry.dismissed) {
    return (
      <div
        className="ml-auto w-fit min-w-0 max-w-[75%] rounded-lg border border-border/60 border-l-2 border-l-muted-foreground/60 bg-card/80 px-3 py-2 text-xs text-muted-foreground shadow-sm"
  ...
  return (
    <div
      className="ml-auto w-fit min-w-0 max-w-[75%] rounded-lg border border-border/60 border-l-2 border-l-message-user bg-card/90 px-3 py-2.5 text-xs text-card-foreground shadow-sm"
      data-testid="ask-user-answer-bubble"
    >
    ...
    if (entry.kind === "system") {
      rendered.push(
        <div
          ...
          className="mx-auto text-center text-xs text-muted-foreground py-1 px-3 rounded-full bg-muted/40 border border-border/40"
        >
          {entry.text}
        </div>,
      );
  ...
  return (
      ...
      {showJumpToBottom && (
        <Button
          ...
          size="sm"
          variant="secondary"
          className="absolute bottom-4 right-5 z-20 h-8 rounded-full border border-border/60 bg-card/95 px-3 text-xs shadow-md backdrop-blur"
      ...
      */}
      ...
      <div className="relative z-30 w-full max-w-full min-w-0 overflow-visible border-t bg-card/95">
        ...
        <div className="w-full max-w-full min-w-0 overflow-x-hidden pb-1 space-y-2">
          ...
          <div className="mx-3 mb-1 rounded-xl bg-input-bar shadow-md overflow-hidden ring-1 ring-border/30">
          <Composer
            ref={composerRef}
            text={question}
