...
export const COMMON_IPC_ERROR_MESSAGES: Readonly<Record<string, string>> = {
  ...
  "tailnet-observer-input-invalid": "formatIpcError.invalidInput",
  "tailnet-observer-unavailable": "formatIpcError.tailnetObserverUnavailable",
  "tailnet-observer-write-failed": "formatIpcError.tailnetObserverWriteFailed",
  ...
  "invalid-session": "formatIpcError.invalidSession",
  "invalid-title": "formatIpcError.invalidTitle",
  "empty-title": "formatIpcError.emptyTitle",
  "invalid-archived": "formatIpcError.invalidArchived",
  "invalid-unread": "formatIpcError.invalidUnread",
  "no-fields": "formatIpcError.noFields",
  ...
  "message-not-found": "formatIpcError.messageNotFound",
  "invalid-message-id": "formatIpcError.invalidMessageId",
  "attachment-not-restorable": "formatIpcError.attachmentNotRestorable",
  ...
  "invalid-processing-display-level": "formatIpcError.invalidValue",
