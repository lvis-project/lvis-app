...
export function RoutineTab({ enableWakeupRoutine, setEnableWakeupRoutine }: RoutineTabProps) {
  return (
    <div className="space-y-4 pt-4">
      <div className="space-y-2">
        <div>
          <p className="text-sm font-medium">웨이크업 루틴</p>
          <p className="text-[11px] text-muted-foreground">장시간 idle 또는 예약 시각에 태스크·일정·메모를 종합한 루틴 결과를 LLM으로 요약해 알려줍니다. 하루 1회, 사용자가 닫으면 24시간 재표시 안 함.</p>
        </div>
