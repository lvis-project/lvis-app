...
function makeReq(overrides: Partial<ApprovalRequest> = {}): ApprovalRequest {
  return {
    ...
    toolName: "read_file",
    args: { path: "/Users/example/Documents/old-project/notes/today/foo.md" },
    reason: "out-of-allowed-dir",
    source: "builtin",
    createdAt: Date.now(),
    requireExplicit: true,
    outOfAllowedDir: {
      candidatePath: "/Users/example/Documents/old-project/notes/today/foo.md",
      suggestedParent: "/Users/example/Documents/old-project/notes/today",
      currentAllowed: ["/Users/example/work"],
      adjacencyWarnings: [],
    },
...
describe("OutOfAllowedDirCard", () => {
  ...
  it("renders the candidate path + suggested-parent + current allowed list", () => {
    ...
    expect(document.body.textContent).toContain("/Users/example/Documents/old-project/notes/today/foo.md");
    expect(document.body.textContent).toContain("/Users/example/Documents/old-project/notes/today");
    expect(document.body.textContent).toContain("/Users/example/work");
  ...
  it("'디렉토리 영구 추가' is DISABLED until user re-types the full suggested directory", () => {
    ...
    const input = getByPlaceholderText("/Users/example/Documents/old-project/notes/today") as HTMLInputElement;
    fireEvent.change(input, { target: { value: "wrong-name" } });
    expect(persist.disabled).toBe(true);
    // typing the exact full directory enables it
    fireEvent.change(input, { target: { value: "/Users/example/Documents/old-project/notes/today" } });
    expect(persist.disabled).toBe(false);
    fireEvent.click(persist);
    expect(onDecide).toHaveBeenCalledWith(
      "allow-always",
      "/Users/example/Documents/old-project/notes/today",
    );
  });
  ...
  it("adjacency warnings render + block persist until acknowledged", () => {
    ...
    const input = getByPlaceholderText("/Users/example/work/proj/.git") as HTMLInputElement;
    fireEvent.change(input, { target: { value: "/Users/example/work/proj/.git" } });
    expect(persist.disabled).toBe(true);
  ...
  it("wraps long path fields inside the dialog", () => {
    ...
    expect(document.body.querySelector("ul.font-mono.break-all")?.textContent).toContain("/Users/example/work");
  });
});
