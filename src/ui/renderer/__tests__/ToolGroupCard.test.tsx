...
describe("ToolGroupCard", () => {
  ...
  it("single tool with host-truncated stub + sessionId → renders CompactedToolResult", () => {
    const stubResult = "[tool_result truncated by host (Issue #902): tool=lge_internal-search_query, toolUseId=tu-truncated, originalLines=180, originalTokens=9000, originalBytes=45000. Call read_tool_result_chunk with toolUseId=\"tu-truncated\" and chunkIndex=0.]";
    vi.stubGlobal("lvisApi", {
      ...
      tools: [
        {
          ...
          name: "lge_internal-search_query",
          input: { query: "긴 규정 답변" },
          result: stubResult,
          status: "done",
          displayOrder: 0,
