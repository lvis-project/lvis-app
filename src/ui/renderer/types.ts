...
export type LvisApi = {
   ...
   * Returns null when session has rotated, toolUseId not found, or verbatim
   * already flushed to disk stub. lineCount is pre-computed server-side. */
  getVerbatimToolResult: (
    sessionId: string,
    toolUseId: string,
