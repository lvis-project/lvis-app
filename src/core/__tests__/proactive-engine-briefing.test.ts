...
import { ProactiveEngine, type ProactiveEngineDeps } from "../proactive-engine.js";

function baseDeps(overrides: Partial<ProactiveEngineDeps> = {}): ProactiveEngineDeps {
  return {
    getTaskSummary: () => [
...
describe("ProactiveEngine.generateDailyBriefing — feature flag gating", () => {
...
describe("ProactiveEngine.generateDailyBriefing — callLlm absence", () => {
...
describe("ProactiveEngine.generateDailyBriefing — idle gate", () => {
...
describe("ProactiveEngine.generateDailyBriefing — dismissal suppression", () => {
...
describe("ProactiveEngine.generateDailyBriefing — no_signals", () => {
