 ...
 *
 * §6.3 Layer 1 Filter: filterByDenyRules()로 Internal search에 노출할 도구를 제어.
 * "차단된 도구는 Internal search가 존재 자체를 알 수 없다" — 아키텍처 핵심 보안 원칙.
 */
...
export class ToolRegistry {
  ...
  /** §6.3 Layer 1 — deny 규칙 적용 후 Internal search에 노출할 도구만 반환 */
