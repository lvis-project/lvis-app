  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className="relative grow overflow-hidden rounded-full bg-ui-line data-[orientation=horizontal]:h-1.5 data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-1.5"
      >
