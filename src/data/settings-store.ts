...
function mergeLlmPatch(base: LLMSettings, partial: LLMSettingsPatch): LLMSettings {
  ...
  // Coerce stale on-disk `provider` (e.g. removed vendor "internal-search") to the
 ...
 * System-theme users get DEFAULT_BUNDLE_ID (or violet-dark+followSystem for corporate),
