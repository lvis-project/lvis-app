...
export const en = {
  ...
  "pluginInstallDialog.allowPrivateNetworks":
    "This grant can reach private network addresses when an allowed domain resolves there.",
} as const;
export const ko: Record<keyof typeof en, string> = {
  ...
  "pluginInstallDialog.networkAccessTitle": "네트워크 접근 요청",
  "pluginInstallDialog.allowedDomainsLabel": "허용 도메인",
  "pluginInstallDialog.allowPrivateNetworks":
    "허용된 도메인이 사설 네트워크 주소로 해석될 때 해당 주소에도 접근할 수 있습니다.",
};
