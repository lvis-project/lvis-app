...
export const en = {
  ...
  "permissionsTab.osSandboxWindowsConsentBody": "Windows OS isolation needs a one-time administrator install (one UAC prompt), then you must sign out of Windows and back in. Network-only: the filesystem is NOT confined on Windows.",
  ...
  "permissionsTab.osSandboxWindowsReloginHeading": "Install complete — sign out and back in",
  "permissionsTab.osSandboxWindowsReloginPending": "Pending relogin: the sandbox activates after you sign out of Windows and back in.",
...
export const ko: Record<keyof typeof en, string> = {
  ...
  "permissionsTab.osSandboxWindowsConsentBody": "Windows OS 격리는 1회 관리자 설치(UAC 프롬프트 1회)가 필요하며, 이후 Windows 에서 로그아웃했다가 다시 로그인해야 합니다. 네트워크 전용: Windows 에서는 파일시스템이 격리되지 않습니다.",
  ...
  "permissionsTab.osSandboxWindowsReloginHeading": "설치 완료 — 로그아웃 후 다시 로그인하세요",
  "permissionsTab.osSandboxWindowsReloginPending": "재로그인 대기 중: Windows 에서 로그아웃했다가 다시 로그인하면 샌드박스가 활성화됩니다.",
