 ...
 *
 * Claude, OpenAI, Gemini, Copilot(GitHub Models), internal-search
 * 벤더별 tool calling 포맷 차이를 추상화.
 */

// ─── Vendor ─────────────────────────────────────────

export type LLMVendor = "claude" | "openai" | "gemini" | "copilot" | "internal-search";
...
export const LLM_VENDOR_LABELS: Record<LLMVendor, string> = {
  ...
  internal-search: "internal search (사내)",
};
...
export const LLM_DEFAULT_MODELS: Record<LLMVendor, string> = {
  ...
  internal-search: "internal-search-default",
};
