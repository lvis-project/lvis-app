 ...
 *    호스트는 corporate-specific 정보를 알지 못한다 (§1 원칙 "NO plugin-specific code in host").
 */
...
export interface OpenAuthWindowOptions {
  ...
  /**
   * 수집할 쿠키의 도메인 suffix. 예: `["sso.portal.example.com", "portal.example.com"]`.
 ...
 * ".portal.example.com" vs "portal.example.com" 같은 표기 차이로 매칭이 실패하지 않게 한다.
 */
