 ...
 *     개발·해외망·비-사내 사용자를 위한 default.
 *   - `corporate`: the organization 사내 테넌트. 사내 관리자가 등록한 전용 app.
...
// Corporate (the organization) — LVIS Desktop Assistant app registration.
// AppName:     LVIS Desktop Assistant
// Client ID:   6c03089a-96c8-4515-bc01-4fd7a0936cea
// Directory:   5096cde4-642a-45c0-8094-d0c2dec10be3 (the organization tenant)
...
> = {
  ...
  corporate: {
    ...
    description:
      "the organization 사내 테넌트 — LVIS Desktop Assistant (LG-SSO / CA 정책 적용).",
  },
};
