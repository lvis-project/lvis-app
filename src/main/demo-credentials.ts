 ...
 *                                  `"azure-foundry"` (Path 2 hotfix: corporate
 *                                  internal demo target).
 *                                  Read via `getDemoActiveVendor()`.
 *
 * Path 2 hotfix (corporate internal demo):
 ...
 *   return `null`, a baked-in corporate-issued endpoint + key is returned. This
 *   is *security-reviewed user-authorized hardcoding* — see the PR
 *   description for the constraint envelope (corporate internal demo only,
 ...
 * corporate internal demo loop activates by default. The Azure Foundry endpoint
