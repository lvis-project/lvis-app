...
describe("PluginTelemetryClient", () => {
  ...
  it("track() is a no-op when enabled=false", async () => {
    ...
    client.track("plugin_install", { slug: "com.ep.foo", version: "1.0.0" });
  ...
  it("batches multiple events into a single POST", async () => {
    ...
    client.track("plugin_install", { slug: "com.ep.foo", version: "1.0.0" });
    client.track("plugin_uninstall", { slug: "com.ep.bar", version: "2.0.0" });
  ...
  it("calls flush at the configured interval", () => {
    ...
    client.track("plugin_update", { slug: "com.ep.foo", version: "1.0.0" });
    client.start();
  ...
  it("scrubPii strips absolute paths and email addresses", () => {
    ...
    expect(scrubPii("com.ep.meeting-recorder")).toBe("com.ep.meeting-recorder");
