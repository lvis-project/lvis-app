...
const copy = {
  ko: {
    ...
    marketplaceHeading: "플러그인만이 아닙니다 — 기능을 탐색하고 설치합니다.",
    marketplaceBody: "카탈로그에는 플러그인과 함께 스킬 · 에이전트 · MCP 서버 · 모델 제공자 · 테마가 들어 있습니다. 버전, 배포 패키지, 설치 정책을 한 곳에서 확인하고, 앱은 이 카탈로그를 통해 필요한 것을 내려받아 검증한 뒤 등록합니다.",
    marketplaceLink: "마켓플레이스 열기 ",
    storeRows: [
      { name: "Microsoft 365", meta: "ms-graph · v0.5.2 · 사용자 설치 가능", chip: "설치", installed: false },
      { name: "Meeting", meta: "meeting · v0.8.4 · 사용자 설치 가능", chip: "설치", installed: false },
      { name: "Local Indexer", meta: "local-indexer · v0.6.6 · 사용자 설치 가능", chip: "설치됨", installed: true },
    ],
    hubEyebrow: "개인 업무 보드",
  ...
  en: {
    ...
    marketplaceEyebrow: "Marketplace",
    marketplaceHeading: "More than plugins — discover and install capabilities.",
    marketplaceBody: "The catalog carries skills, agents, MCP servers, model providers, and themes alongside plugins. Check versions, distribution packages, and install policies in one place; the app downloads, verifies, and registers what you need through this catalog.",
    marketplaceLink: "Open the marketplace ",
    storeRows: [
      { name: "Microsoft 365", meta: "ms-graph · v0.5.2 · user-installable", chip: "Install", installed: false },
      { name: "Meeting", meta: "meeting · v0.8.4 · user-installable", chip: "Install", installed: false },
      { name: "Local Indexer", meta: "local-indexer · v0.6.6 · user-installable", chip: "Installed", installed: true },
    ],
