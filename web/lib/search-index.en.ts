...
export const searchEntriesEn: SearchEntry[] = [
  ...
  { group: "Chat", href: "/en/docs/chat/plugin-panel", title: "Plugin Panel", snippet: "manifest ui[] slots · registerKeywords · regex ^[a-zA-Z_][a-zA-Z0-9_]*$" },
  ...
  { group: "Plugins", href: "/en/docs/plugins/ep-api", title: "the internal portal", snippet: "24 tools · 6 domains · openAuthWindow session · corporate DNS gateway", keywords: ["lge", "ep", "internal-search"] },
  ...
  { group: "Servers", href: "/en/docs/servers/marketplace/skills", title: "Marketplace — Skills", snippet: "SKILL.md · ~/.lvis/skills/<name>/ · registerKeywords" },
