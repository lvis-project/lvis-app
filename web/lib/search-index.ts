...
export const searchIndex: SearchEntry[] = [
  ...
  { group: "채팅", href: "/docs/chat/plugin-panel", title: "플러그인 패널", snippet: "manifest ui[] 슬롯 · registerKeywords · 정규식 ^[a-zA-Z_][a-zA-Z0-9_]*$" },
  ...
  { group: "플러그인", href: "/docs/plugins/ep-api", title: "the internal portal (포털)", snippet: "24 tools · 6 domain · openAuthWindow 세션 · 사내망 DNS 게이트", keywords: ["lge", "ep", "internal-search"] },
  ...
  { group: "서버", href: "/docs/servers/marketplace/skills", title: "Marketplace — Skills", snippet: "SKILL.md · ~/.lvis/skills/<name>/ · registerKeywords" },
