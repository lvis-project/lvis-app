...
const layers = [
  ...
  },
  {
    ...
    boxes: [
      ...
      "ms-graph · the internal portal · internal search (external APIs)",
    ],
  },
];
  ...
  return (
    <article>
      ...
      <Callout tone="info" title="6 active plugins (2026-05-20)">
        ...
        agent-hub (v0.8.1) · ep-api (v0.12.9). Archived: lvis-plugin-email (2026-04-28), lvis-plugin-calendar (2026-04-30) — both consolidated into ms-graph.
      </Callout>
