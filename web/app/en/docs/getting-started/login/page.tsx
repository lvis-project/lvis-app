  ...
  return (
    <article>
      <PageHero
        ...
        description="The host app itself is local-first, but a Marketplace account is required for the plugin catalog, downloads, and signature verification. Auth is handled on the plugin side via hostApi.openAuthWindow / hostApi.openAuthPartitionViewer."
      />
      ...
      <Callout tone="tip" title="What works without logging in">
        ...
        However, installing new plugins and the Marketplace catalog are disabled.
      </Callout>
