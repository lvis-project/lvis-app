  ...
  return (
    <article>
      <PageHero
        ...
        tags={["Meeting + Work Assistant + MS-Graph", "Local Indexer + Meeting + Agent Hub", "MS-Graph + the internal portal", "Agent Hub + Meeting + EP"]}
      />
      ...
      <StepList
        steps={[
          ...
          { title: "Room booked + video call added", body: <p>The chosen room is confirmed with <strong>the internal portal</strong>'s room booking tool. If there are external attendees, a video call link is generated automatically and attached to the event body.</p>, badge: "the internal portal" },
      ...
      <StepList
        steps={[
          { title: "Join the video call", body: <p>Start the video call from the link attached to the event — <strong>the internal portal</strong>'s video call flow.</p>, badge: "the internal portal" },
