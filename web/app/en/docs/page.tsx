...
const layers = [
  ...
  { tag: "Plugin Runtime", label: "6 plugins", note: "ms-graph · local-indexer · meeting · work-assistant · agent-hub · ep-api" },
...
const features = [
  ...
  { eyebrow: "Plugins", title: "6 active plugins", desc: "Local Indexer · MS-Graph · Meeting · Work Assistant · Agent Hub · the internal portal.", href: "/en/docs/plugins", icon: Plug, span: "lg:col-span-3" },
