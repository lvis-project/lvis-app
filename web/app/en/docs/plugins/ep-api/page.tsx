...
export const metadata = { title: "the internal portal Plugin" };

export default function Page() {
  return (
    <article>
      <PageHero
        eyebrow="Plugin · the internal portal"
        title="the internal portal — bringing the corporate portal into LVIS"
        description="A single sign-in to the corporate portal EP handles attendance, approvals, parking, meeting room booking, video calls, and the internal search tool internal search, all inside LVIS chat. Works only on the corporate network."
      ...
      <Tabs defaultValue="login" className="my-6">
        <TabsList className="flex flex-wrap">
          ...
          <TabsTrigger value="internal-search">internal search</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="internal-search">
          <ScreenshotGallery columns={2}>
            <ScreenshotCard src={shotUrl("ep-internal-search")} caption={shots["ep-internal-search"].captionEn} />
            <ScreenshotCard src={shotUrl("ep-internal-search-2")} caption={shots["ep-internal-search-2"].captionEn} />
          </ScreenshotGallery>
          <p>Brings results from the internal search tool internal search into LVIS chat context. Answers questions about internal policies, regulations, and forms with citations.</p>
        </TabsContent>
      </Tabs>
