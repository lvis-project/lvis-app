...
export default function Page() {
  return (
    <article>
      ...
      <StepList
        steps={[
          { title: "Deeplink from Marketplace", body: <p>The "Install" button on the web page fires <code>lvis://install/&lt;slug&gt;</code> or <code>lvis://install/&lt;type&gt;/&lt;slug&gt;</code>. The host receives and handles the URL (<code>src/main/lvis-protocol.ts</code>).</p> },
          { title: "Package + signature verification", body: <p>The host verifies the Ed25519 signature envelope issued by the Marketplace. It passes once at least one signature matches a known public key (<code>marketplace/server/src/lvis_marketplace/signing.py</code>).</p>, badge: "sig" },
