...
export const metadata = { title: "the internal portal 플러그인" };
  ...
  return (
    <article>
      <PageHero
        ...
        title="the internal portal — 사내 포털을 LVIS 안으로"
        description="사내 포털 EP 의 한 번 로그인으로 근태 · 결재 · 주차 · 회의실 예약 · 화상회의 · 사내 검색 internal search 까지 LVIS 채팅 안에서 처리합니다. 사내망에서만 동작합니다."
      ...
      <Tabs defaultValue="login" className="my-6">
        ...
        <TabsContent value="internal-search">
          <ScreenshotGallery columns={2}>
            <ScreenshotCard src={shotUrl("ep-internal-search")} caption={shots["ep-internal-search"].caption} />
            <ScreenshotCard src={shotUrl("ep-internal-search-2")} caption={shots["ep-internal-search-2"].caption} />
          </ScreenshotGallery>
          <p>사내 검색 internal search 의 결과를 LVIS 채팅 컨텍스트로 가져옵니다. 사내 정책 · 규정 · 양식 같은 질문에 인용과 함께 답합니다.</p>
        </TabsContent>
      </Tabs>
