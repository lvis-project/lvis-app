...
const features = [
  ...
  { eyebrow: "Plugins", title: "6개 active 플러그인", desc: "Local Indexer · MS-Graph · Meeting · Work Assistant · Agent Hub · the internal portal.", href: "/docs/plugins", icon: Plug, span: "lg:col-span-3" },
