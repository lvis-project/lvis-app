...
export default function Page() {
  return (
    <article>
      ...
      />
      <p>
        어떤 모드든 <strong>사용자가 직접 타이핑한 말만</strong> 메모 후보가 됩니다. 첨부 파일 본문, 다른 에이전트가 보낸 말,
        외부 창구로 들어온 메시지처럼 사용자가 쓴 것이 아닌 내용은 후보에서 제외됩니다 — 그렇지 않으면 남이 쓴 문장이 사용자의 항구적인 사실로 굳어질 수 있습니다.
      </p>

      <h2 id="project">프로젝트가 가진 지침도 함께 읽습니다</h2>
      <p>
        작업 중인 프로젝트 폴더에 팀이 함께 쓰는 <code>AGENTS.md</code> 가 있으면 호스트가 그것도 읽어 참고합니다.
        이것은 사용자 개인 메모리와 <strong>다른 층</strong> 으로 취급되고, 충돌하면 개인 메모리가 우선합니다.
        프로젝트 파일은 LVIS 가 고쳐 쓰지 않습니다 — 읽기만 합니다.
      </p>
