    ...
    <article>
      ...
      <StepList
        steps={[
          ...
          { title: "회의실 예약 + 화상회의 추가", body: <p>선택한 회의실은 <strong>the internal portal</strong> 의 회의실 예약 도구로 확정. 외부 참가자가 있으면 화상회의 링크가 자동 생성되어 일정 본문에 첨부.</p>, badge: "the internal portal" },
      ...
      <StepList
        steps={[
          { title: "화상회의 진입", body: <p>일정에 첨부된 링크로 화상회의 시작 — <strong>the internal portal</strong> 의 화상회의 흐름.</p>, badge: "the internal portal" },
