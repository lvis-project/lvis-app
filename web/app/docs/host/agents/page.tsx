...
export default function Page() {
  return (
    <article>
      ...
      <ul>
        <li><strong>깨끗한 문맥에서 시작합니다.</strong> 하위 에이전트는 부모의 대화 기록을 물려받지 않습니다. 부모가 지정한 도구만 쓸 수 있고, 그 범위는 처음 띄운 시점에 고정되어 나중에 넓어지지 않습니다.</li>
        <li><strong>기다리지 않습니다.</strong> 하위 에이전트는 항상 백그라운드에서 돌고, 부모는 즉시 실행 손잡이를 받습니다. 결과는 나중에 메시지로 도착합니다.</li>
      ...
      <Callout tone="security" title="하위 에이전트의 권한 질문은 부모가 먼저 받습니다">
        ...
        부모가 답할 수 있는 범위에는 상한이 있고 <strong>높은 위험도는 언제나 사용자에게</strong> 옵니다 — <a href="/docs/architecture/permissions#subagent">권한 모델</a> 참고.
      </Callout>
