...
const layers = [
  ...
  },
  {
    ...
    boxes: [
      ...
      "MCP servers (외부)",
      "ms-graph · the internal portal · internal search (외부 API)",
    ],
  },
];
  ...
  return (
    <article>
      ...
      <Callout tone="info" title="6개 active 플러그인 (2026-05-20)">
        ...
        agent-hub (v0.8.1) · ep-api (v0.12.9). archived: lvis-plugin-email (2026-04-28), lvis-plugin-calendar (2026-04-30) — 둘 다 ms-graph 로 통합됨.
      </Callout>
