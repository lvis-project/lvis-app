    ...
    <article>
      ...
      <FeatureGrid
        ...
        items={[
          ...
          { title: "번들 Skill 지침", body: <>플러그인은 <code>manifest.skills</code>로 artifact 안의 지침을 선언할 수 있습니다. Skill 은 플러그인을 활성화하거나 Tool 을 선택·호출하지 않으며, Host-selected scope와 <code>tool_search</code>가 Tool 발견을 담당합니다.</>, tone: "citron" },
