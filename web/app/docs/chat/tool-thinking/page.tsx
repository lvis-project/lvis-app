  ...
  return (
    <article>
      ...
      <ul>
        ...
        <li><strong>외부 MCP 도구</strong> — 사용자가 등록한 외부 MCP 서버의 도구. 가장 낮은 신뢰 등급으로 다뤄져 <a href="/docs/host/mcp#beyond-tools">기본 모드에서는 매번 확인을 받습니다</a>.</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>이미지 보기</strong> — PC 안의 이미지 파일 (png · jpeg · gif · webp) 을 모델이 실제로 <em>볼</em> 수 있게 불러옵니다. 파일 크기에는 상한이 있고, 이미지가 아닌 파일은 거절됩니다.</li>
