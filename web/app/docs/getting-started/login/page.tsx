  ...
  return (
    <article>
      ...
      <ul>
        ...
        <li><strong>ms-graph, ep-api</strong> — 각 플러그인 자체 OAuth (MSAL · EP SSO). 토큰은 plugin namespace 에 격리.</li>
      </ul>
      ...
      <StepList
        steps={[
          ...
          { title: "Plugin OAuth — 필요 시", body: <p>ms-graph (MSAL) / ep-api (EP SSO) 는 plugin install 후 첫 사용 시 <code>hostApi.openAuthWindow</code> 로 별도 처리.</p> },
        ]}
      />
