...
This English page is the canonical default entry for `references/vercel-migration-baseline.md`. The preserved Korean source is available at [ko/references/vercel-migration-baseline.md](../ko/references/vercel-migration-baseline.md).
...
- [Korean Mirror](../ko/references/vercel-migration-baseline.md)
