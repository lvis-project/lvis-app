...
This is the English default page for `docs/references/vercel-migration-baseline.md`. The Korean source document is preserved at [docs/ko/references/vercel-migration-baseline.md ](../ko/references/vercel-migration-baseline.md).
