...
This English page is the canonical default entry for `references/tool-result-kind-sentinels.md`. The preserved Korean source is available at [ko/references/tool-result-kind-sentinels.md](../ko/references/tool-result-kind-sentinels.md).
...
- [Korean Mirror](../ko/references/tool-result-kind-sentinels.md)
