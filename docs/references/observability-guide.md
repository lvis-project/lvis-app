...
Korean archive: [docs/ko mirror](../ko/references/observability-guide.md).

## What This Page Owns

This page owns logs, audit rows, telemetry, traces, and diagnostic breadcrumbs without leaking sensitive content. Use it as the first review surface when changing this area; use the archive for background, not as a substitute for current English guidance.
