...
Korean archive: [docs/ko mirror](../ko/development/multi-worker-discipline.md).

## What This Page Owns

This page owns parallel worker ownership, integration rules, shared-file discipline, and verification sequencing. Use it as the first review surface when changing this area; use the archive for background, not as a substitute for current English guidance.
