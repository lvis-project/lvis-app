...
This English page is the canonical default entry for `development/multi-worker-discipline.md`. The preserved Korean source is available at [ko/development/multi-worker-discipline.md](../ko/development/multi-worker-discipline.md).
...
- [Korean Mirror](../ko/development/multi-worker-discipline.md)
