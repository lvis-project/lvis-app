...
Korean archive: [docs/ko mirror](../ko/development/theme-system.md).

## What This Page Owns

This page owns theme tokens, shared renderer styling, plugin shell styling, and visual regression checks. Use it as the first review surface when changing this area; use the archive for background, not as a substitute for current English guidance.
