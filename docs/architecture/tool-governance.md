...
Korean archive: [docs/ko mirror](../ko/architecture/tool-governance.md).

## What This Page Owns

This page owns tool exposure, approval, review, audit, and execution across builtin, plugin, MCP, and delegated-agent paths. Use it as the first review surface when changing this area; use the archive for background, not as a substitute for current English guidance.
