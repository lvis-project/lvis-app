# Suggested Replies Ghost Text

This English page is the canonical default entry for `architecture/proposals/suggested-replies-ghost-text.md`. The preserved Korean source is available at [ko/architecture/proposals/suggested-replies-ghost-text.md](../../ko/architecture/proposals/suggested-replies-ghost-text.md).
...
- [Korean Mirror](../../ko/architecture/proposals/suggested-replies-ghost-text.md)
