...
Korean archive: [docs/ko mirror](../../ko/architecture/proposals/suggested-replies-ghost-text.md).

## What This Page Owns

This page owns suggested reply and ghost text behavior that stays advisory until the user explicitly accepts it. Use it as the first review surface when changing this area; use the archive for background, not as a substitute for current English guidance.
