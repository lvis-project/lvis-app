...
Korean archive: [docs/ko mirror](../../ko/architecture/proposals/live-autoplay.md).

## What This Page Owns

This page owns the consent, focus, and notification constraints for any live media or automated playback surface. Use it as the first review surface when changing this area; use the archive for background, not as a substitute for current English guidance.
