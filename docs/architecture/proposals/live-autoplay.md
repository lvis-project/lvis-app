...
This English page is the canonical default entry for `architecture/proposals/live-autoplay.md`. The preserved Korean source is available at [ko/architecture/proposals/live-autoplay.md](../../ko/architecture/proposals/live-autoplay.md).
...
- [Korean Mirror](../../ko/architecture/proposals/live-autoplay.md)
