    ...
    "managedPlugins": [
      {
        ...
        "version": "0.2.0",
        "source": "https://internal.portal.example.com/lvis/marketplace/api/v1/plugins/lvis-plugin-pageindex/0.2.0.tgz",
        "sha256": "abc123def456...",
        "forceInstall": true,
        "autoUpdate": true,
        "lockEnabled": true,
      ...
      },
      {
        ...
        "version": "1.1.3",
        "source": "https://internal.portal.example.com/lvis/marketplace/api/v1/plugins/lvis-plugin-meeting/1.1.3.tgz",
        "sha256": "def789abc012...",
        "forceInstall": true,
        "autoUpdate": true
      }
...
export class ManagedPolicySync {
  constructor(
    private readonly opts: {
      ...
      apiEndpoint: string;          // https://internal.portal.example.com/lvis/policy
