...
This English page is the canonical default entry for `architecture/plugin-deployment-model.md`. The preserved Korean source is available at [ko/architecture/plugin-deployment-model.md](../ko/architecture/plugin-deployment-model.md).
...
- [Korean Mirror](../ko/architecture/plugin-deployment-model.md)
