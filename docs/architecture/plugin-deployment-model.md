...
Korean archive: [docs/ko mirror](../ko/architecture/plugin-deployment-model.md).

## What This Page Owns

This page owns plugin artifact validation, install state, registry updates, receipts, quarantine, and plugin-owned data cleanup. Use it as the first review surface when changing this area; use the archive for background, not as a substitute for current English guidance.
