...
| **L3** | 실행·추론 | Internal search(사내 LLM) 세션 + Agent Loop + Tool 실행 |
...
│                         │                           │
│  ┌──────────────────────┴────────────────────────┐  │
│  │  Memory (AGENTS.md · MEMORY.md) · SQLite · Local Indexer│  │
│  └───────────────────────────────────────────────┘  │
└─────────────────────┬───────────────────────────────┘
                      │ SSE Streaming
              ┌───────┴───────┐
...
| Server | Internal search (사내 LLM), Agent Hub (Go/Rust + PostgreSQL + NATS), Marketplace |
