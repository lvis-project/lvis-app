...
This English page is the canonical default entry for `architecture/README.md`. The preserved Korean source is available at [ko/architecture/README.md](../ko/architecture/README.md).
...
- [Korean Mirror](../ko/architecture/README.md)
