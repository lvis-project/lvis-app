...
|------|---------|------------|
| [`chat-continuous-v3.html`](./chat-continuous-v3.html) | Continuous chat / Kakao-style stream / invisible auto-checkpoint / 3-tier rotation. Reference systems: Warp Agent topic-shift, OpenCode auto-compact, GitHub Copilot Checkpoints. | Absorbed into ChatView; StackedChatView removed in #547 |
