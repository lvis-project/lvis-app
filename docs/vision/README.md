...
This English page is the canonical default entry for `vision/README.md`. The preserved Korean source is available at [ko/vision/README.md](../ko/vision/README.md).

## Purpose

Vision pages explain why LVIS exists and how the desktop app should feel for project-aware personal work.

## When To Use This Page

Use this page when product scope, default workflows, or app-level interaction principles are being debated.
...
- Keep the product promise concrete.
- Tie vision back to app behavior and project/memory boundaries.
- Avoid marketing copy that does not guide implementation.
- Link to architecture docs for enforcement details.
...
- [Korean Mirror](../ko/vision/README.md)
