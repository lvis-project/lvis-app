...
Korean archive: [docs/ko mirror](../ko/onboarding/demo-activation.md).

## What This Page Owns

This page owns demo activation from first launch through credential validation, LLM key setup, sandbox preparation, and retry. Use it as the first review surface when changing this area; use the archive for background, not as a substitute for current English guidance.
...
- `src/ipc/domains/demo.ts`
- `src/main/demo-credentials.ts`
- `src/ui/renderer/onboarding/`
