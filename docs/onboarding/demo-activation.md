...
This English page is the canonical default entry for `onboarding/demo-activation.md`. The preserved Korean source is available at [ko/onboarding/demo-activation.md](../ko/onboarding/demo-activation.md).
...
- [Korean Mirror](../ko/onboarding/demo-activation.md)
