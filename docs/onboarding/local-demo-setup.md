...
Korean archive: [docs/ko mirror](../ko/onboarding/local-demo-setup.md).

## What This Page Owns

This page owns local demo setup and reset paths that do not require production infrastructure or real secrets. Use it as the first review surface when changing this area; use the archive for background, not as a substitute for current English guidance.
