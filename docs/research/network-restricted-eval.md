...
This is the English default page for `docs/research/network-restricted-eval.md`. The Korean source document is preserved at [docs/ko/research/network-restricted-eval.md ](../ko/research/network-restricted-eval.md).
