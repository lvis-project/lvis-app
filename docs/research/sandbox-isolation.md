...
Korean archive: [docs/ko mirror](../ko/research/sandbox-isolation.md).

## What This Page Owns

This page owns sandbox capability reporting across OS, plugin, MCP, reviewer prompt, and approval UI paths. Use it as the first review surface when changing this area; use the archive for background, not as a substitute for current English guidance.
