...
This English page is the canonical default entry for `research/sandbox-isolation.md`. The preserved Korean source is available at [ko/research/sandbox-isolation.md](../ko/research/sandbox-isolation.md).
...
- [Korean Mirror](../ko/research/sandbox-isolation.md)
