...
Korean archive: [docs/ko mirror](../ko/guides/local-marketplace-testing.md).

## What This Page Owns

This page owns local marketplace fixtures, offline cache behavior, install receipts, and quarantine testing. Use it as the first review surface when changing this area; use the archive for background, not as a substitute for current English guidance.
