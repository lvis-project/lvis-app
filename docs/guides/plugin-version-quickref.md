...
This English page is the canonical default entry for `guides/plugin-version-quickref.md`. The preserved Korean source is available at [ko/guides/plugin-version-quickref.md](../ko/guides/plugin-version-quickref.md).
...
- [Korean Mirror](../ko/guides/plugin-version-quickref.md)
