...
This English page is the canonical default entry for `guides/getting-started.md`. The preserved Korean source is available at [ko/guides/getting-started.md](../ko/guides/getting-started.md).
...
- [Korean Mirror](../ko/guides/getting-started.md)
