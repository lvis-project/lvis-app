...
This English page is the canonical default entry for `guides/plugin-decoupling-migration.md`. The preserved Korean source is available at [ko/guides/plugin-decoupling-migration.md](../ko/guides/plugin-decoupling-migration.md).
...
- [Korean Mirror](../ko/guides/plugin-decoupling-migration.md)
