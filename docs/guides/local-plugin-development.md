...
This English page is the canonical default entry for `guides/local-plugin-development.md`. The preserved Korean source is available at [ko/guides/local-plugin-development.md](../ko/guides/local-plugin-development.md).
...
- [Korean Mirror](../ko/guides/local-plugin-development.md)
