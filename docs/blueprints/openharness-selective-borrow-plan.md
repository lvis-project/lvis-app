...
Korean archive: [docs/ko mirror](../ko/blueprints/openharness-selective-borrow-plan.md).

## What This Page Owns

This page owns how reference harness ideas are evaluated before being adapted to LVIS desktop constraints. Use it as the first review surface when changing this area; use the archive for background, not as a substitute for current English guidance.
