...
This English page is the canonical default entry for `blueprints/openharness-selective-borrow-plan.md`. The preserved Korean source is available at [ko/blueprints/openharness-selective-borrow-plan.md](../ko/blueprints/openharness-selective-borrow-plan.md).
...
- [Korean Mirror](../ko/blueprints/openharness-selective-borrow-plan.md)
