# Composer Redesign Message Queue
...
Korean archive: [docs/ko mirror](../ko/blueprints/composer-redesign-message-queue.md).

## What This Page Owns

This page owns busy-turn message queue behavior, explicit interrupt paths, and turn-end automatic intake. Use it as the first review surface when changing this area; use the archive for background, not as a substitute for current English guidance.
