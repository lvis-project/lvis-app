...
This English page is the canonical default entry for `blueprints/composer-redesign-message-queue.md`. The preserved Korean source is available at [ko/blueprints/composer-redesign-message-queue.md](../ko/blueprints/composer-redesign-message-queue.md).
...
- [Korean Mirror](../ko/blueprints/composer-redesign-message-queue.md)
