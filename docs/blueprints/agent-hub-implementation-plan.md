...
Korean archive: [docs/ko mirror](../ko/blueprints/agent-hub-implementation-plan.md).

## What This Page Owns

This page owns Agent Hub work tracking, approval, execution, run history, report generation, and project-linked work state. Use it as the first review surface when changing this area; use the archive for background, not as a substitute for current English guidance.
