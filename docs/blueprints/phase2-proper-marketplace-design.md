# Phase2 Proper Marketplace Design
...
Korean archive: [docs/ko mirror](../ko/blueprints/phase2-proper-marketplace-design.md).

## What This Page Owns

This page owns marketplace discovery, validation, install, update, disable, uninstall, receipt, cache, and quarantine behavior. Use it as the first review surface when changing this area; use the archive for background, not as a substitute for current English guidance.
