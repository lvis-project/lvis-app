...
Korean archive: [docs/ko mirror](../ko/blueprints/autopilot-phase1-indexer.md).

## What This Page Owns

This page owns bounded indexing and retrieval for autonomous work context, including privacy and token-budget constraints. Use it as the first review surface when changing this area; use the archive for background, not as a substitute for current English guidance.
