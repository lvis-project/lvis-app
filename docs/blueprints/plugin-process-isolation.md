...
- **No Electron.** `require("electron")` in the child yields nothing. `BrowserWindow`,
  ...
  separately: `import("electron")` resolves to an inert namespace and a named
  import fails to link.
