...
`/Users/example/.claude/projects/-Users-ken-workspace-GIT-github-lvis-project/memory/feedback_no_voice_input_host.md` saved 2026-04-14. Future sessions will not re-propose voice STT for chat input. Meeting plugin STT (transcription) remains in scope and is explicitly excepted.
